...
class ColumnMapSchema:
    def __init__(self, map:Dict[str, Any], column_names:List[str]):
        self._map                  : Dict[str, Union[int, List[int], None]] = {
            "session_id"           : None,
            "app_id"               : None,
            "timestamp"            : None,
            "event_name"           : None,
    ...
    @property
    def Map(self) -> Dict[str, Union[int, List[int], None]]:
        return self._map

    @property
    def SessionID(self) -> Union[int, List[int], None]:
        return self._map['session_id']

    @property
    def AppID(self) -> Union[int, List[int], None]:
        return self._map['app_id']

    @property
    def Timestamp(self) -> Union[int, List[int], None]:
        return self._map['timestamp']

    @property
    def EventName(self) -> Union[int, List[int], None]:
        return self._map['event_name']

    @property
    def EventData(self) -> Union[int, List[int], None]:
        return self._map['event_data']

    @property
    def EventSource(self) -> Union[int, List[int], None]:
    ...
    @property
    def TimeOffset(self) -> Union[int, List[int], None]:
        return self._map['time_offset']

    @property
    def UserID(self) -> Union[int, List[int], None]:
        return self._map['user_id']

    @property
    def UserData(self) -> Union[int, List[int], None]:
        return self._map['user_data']

    @property
    def GameState(self) -> Union[int, List[int], None]:
        return self._map['game_state']

    @property
    def EventSequenceIndex(self) -> Union[int, List[int], None]:
    ...
    @staticmethod
    def _parseElement(elem:Any, name:str) -> Union[str, List[str], None]:
        ret_val : Union[str, List[str], None]
        if elem is not None:
