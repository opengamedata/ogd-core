...
class Event:
    def __init__(self, session_id:str, app_id:str,             timestamp:datetime,
                 ...
                 log_version:Optional[SemanticVersion] = None, time_offset:Optional[timezone] = None,
    ...
    def ColumnValues(self) -> List[Union[str, datetime, timezone, utils.map, int, SemanticVersion, None]]:
