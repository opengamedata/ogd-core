...
class Model(Generator):
    ...
    @abc.abstractmethod
    def _apply(self, apply_to:List[Feature | Event]) -> Feature | Event:
        pass
    ...
    def _updateFromFeature(self, feature:Feature):
        ...
        TODO : this will get removed once patch is in that puts _updateFromFeature in Generator base class.
    ...
    def Apply(self, apply_to:List[Feature | Event]) -> Feature | Event:
