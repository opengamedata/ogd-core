...
class TextClickCount(SessionFeature):
    ...
    def _eventFilter(cls, mode:ExtractionMode) -> List[str]:
        ...
        :rtype: List[str]
        """
        return ["text_click"] # >>> fill in names of events this Feature should use for extraction. <<<
    ...
    def _updateFromEvent(self, event:Event) -> None:
        ...
        ##if event.EventData.get('name') == "text_click": 
        self._text_click_count += 1
        ##elif 'cick' in event.EventName:
            ##self._text_click_count+=1
        return
