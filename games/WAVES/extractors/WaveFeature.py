...
class WaveFeature(abc.ABC):
    ...
    ## Abstract function to get a list of event types the feature uses.
    #  Each subclass will set its own list of feature types.
    @abc.abstractmethod
    def GetEventTypes(self) -> typing.List[str]:
        pass
